...
<div class="container-fluid card card-detail-proyek">
    ...
    <div>
        ...
        @else
            <div class="row">
                ...
                <div class="col-sm-2">
                    <button type="button" class="btn btn-primary disabled"  onclick="window.location.href='/proyek/ubah/{{ $proyek->id }}'">Ubah</button> 
                </div>
            </div>
        @endif
        <br>
    ...
    <div>
        <div class="row ketengahin">
            <a href="#"><div class="col-sm-12 card card-button-1">
