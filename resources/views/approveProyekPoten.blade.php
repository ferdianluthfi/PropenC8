...
<div class="container-fluid card card-detail-proyek">
    <br>
    <p class="font-subtitle-1" style="text-align:center">Detail Proyek {{ $proyek->projectName}}</p>
    <p style="color:orange; text-align:center; font-size:11px; font-weight:bolder;">STATUS : {{$status}}</p>    
    <hr>
    <div> 
        <!-- <div class="row">
            <div class="col-sm-10"> 
                <p class="font-subtitle-2">Detail Proyek </p>
            </div>
        </div> -->
    <br>
    </div>
